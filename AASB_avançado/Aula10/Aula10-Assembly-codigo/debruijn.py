...
class DeBruijnGraph (MyGraph): #os nossos vértices passam a ser os prefixos
    
    def __init__(self, frags):
        MyGraph.__init__(self, {})
        self.create_deBruijn_graph(frags)

    def add_edge(self, o, d): #vai adicionar um edge entre o O e o D
    ...
    def in_degree(self, v): #vai calcular o numero de ligações in ao vértice v
        res = 0
